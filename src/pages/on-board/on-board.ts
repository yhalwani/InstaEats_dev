...
pushMenu(name){
  ...
  for (var i = 0; i < length; i++) {
    childNode.update({
      ...
      //   for (let j = i; j < this.menuGroup[i].menu.length; j++)
      //     childNode.child(this.menuGroup[i].groupName).set({
      //       [this.menuGroup[i].menu[j].name]:
      //       {
      ...
      // do{
      //   menuNode.child(name).set({
      //     [this.menuGroup[index].groupName]: {
      //       name: this.menuGroup[index].menu[index].name,
      //       description: this.menuGroup[index].menu[index].description,
      //       price: this.menuGroup[index].menu[index].price
      //     }
      //   });
      //   index++;
      // }while(index < length);
